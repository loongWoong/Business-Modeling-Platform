              ...
              datasources.map(datasource => (
                <tr key={datasource.id}>
                    ...
                    <span 
                      ...
                      onClick={() => {
                        ...
                        if (typeof window !== 'undefined' && window.location) {
                          window.location.href = `/datasource/${datasource.datasourceId || datasource.id}`;
                        }
                      }}
                    >
                      {datasource.name}
                  ...
                  <td>
                    ...
                    <button className="delete" onClick={() => handleDeleteDatasource(datasource.id, datasource.associationId)}>删除关联</button>
                  </td>
                </tr>
              ))
            ) : (
